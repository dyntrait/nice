...
use http::HeaderName;
use nice_core::CleanDrop;
use nice_cryptography::providers::install_cryptographic_provider;
#[cfg(feature = "turmoil")]
...
#[cfg_attr(
    feature = "python",
    pyo3::pyclass(module = "nice_trader.core.nice_pyo3.network")
)]
...
mod rust_tests {
    ...
    async fn test_send_timeout_uses_configured_reconnect_timeout() {
        ...
        use nice_common::testing::wait_until_async;
