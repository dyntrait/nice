...
//
//  @File         : client_order_id.rs.rs
//  @Author       : dyntrait Created On 2026/1/5 15:51
//  @Description  : 
//
...
use nice_core::{AtomicTime, uuid::UUID4};
use nice_model::identifiers::{ClientOrderId, StrategyId, TraderId};
...
#[cfg(test)]
mod tests {
    use nice_core::time::get_atomic_clock_static;
    use nice_model::{
